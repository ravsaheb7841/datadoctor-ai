      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={() => downloadFile(
                `${API_URL}/api/datasets/${id}/download/xlsx`,
                `cleaned_dataset_${id}.xlsx`
              )}
              disabled={loading}
            ...
            <button
              onClick={() => downloadFile(
                `${API_URL}/api/datasets/${id}/download/json`,
                `cleaned_dataset_${id}.json`
              )}
              disabled={loading}
        ...
        <div className="px-6 py-5 border-b border-gray-200 dark:border-gray-700 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">
              Everything packed into your export
            </p>
          </div>
        </div>
          ...
          {[
            {
              ...
              items: [
                'Health score and quality summary',
            ...
            },
            {
              ...
              items: [
                'All applied cleaning operations',
            ...
            <div
              key={block.title}
              className="bg-gray-50 dark:bg-gray-700/40 rounded-xl p-5 border border-gray-100 dark:border-gray-600"
            >
