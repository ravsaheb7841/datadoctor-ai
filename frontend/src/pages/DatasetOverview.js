      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          return (
            ...
            >
              <div
                className={`absolute top-0 right-0 w-20 h-20 bg-gradient-to-br ${colorMap[item.color]} opacity-10 rounded-full -translate-y-1/2 translate-x-1/2 group-hover:scale-150 transition-transform duration-500`}
              ></div>

              <div
                className={`inline-flex p-2.5 rounded-xl bg-gradient-to-br ${colorMap[item.color]} text-white shadow-lg mb-3`}
              >
          ...
          {quickActions.map((action, idx) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`inline-flex p-3 rounded-xl bg-gradient-to-br ${action.gradient} text-white shadow-lg ${action.shadow} mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
                  <Icon className="w-5 h-5" />
                </div>
              ...
              {dataset.data_preview?.slice(0, 10).map((row, index) => (
                ...
                >
                  ...
                  {dataset.column_names?.map((col) => (
                    <td
                      key={col}
                      className="px-5 py-3 text-sm text-gray-800 dark:text-gray-200 whitespace-nowrap"
                    >
